...
void SaveStatement(bool mass[][1000]){
    ...
    for (int i = 0; i < 6; i++){
        for (int j = 0; j < 1000; j++){
            if (i == 0 && mass[i][j]) saving << "100" << endl;
            else if (i == 1 && mass[i][j]) saving << "200" << endl;
            else if (i == 2 && mass[i][j]) saving << "500" << endl;
            else if (i == 3 && mass[i][j]) saving << "1000" << endl;
            else if (i == 4 && mass[i][j]) saving << "2000" << endl;
            else if (i == 5 && mass[i][j]) saving << "5000" << endl;
        }
    }
    saving.close();
}
